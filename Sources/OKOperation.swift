...
public class OKOperation: Operation {
    ...
    */
    ...
    final public func addCondition(_ condition: OperationCondition) {
    ...
    final public func addObserver(_ observer: OperationObserver) {
...
private func <(lhs: OKOperation.State, rhs: OKOperation.State) -> Bool {
