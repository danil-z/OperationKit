...
open class OKOperationQueue: Foundation.OperationQueue {
    ...
    override open func addOperations(_ operations: [Operation], waitUntilFinished wait: Bool) {
        /*
